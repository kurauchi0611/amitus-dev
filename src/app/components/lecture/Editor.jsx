  ...
  render() {
    return (
      <div>
        ...
        <select id="keybind" onChange={this.onChangeKeybind.bind(this)}>
          {keybinds.map((kb, i) => (
        ...
        <select id="fontsize" onChange={this.onChangeFontsize.bind(this)}>
        ...
        <label htmlFor="autocomplete">
          ...
          <input
            ...
            onChange={this.toggleAutoComplete.bind(this)}
          />
        </label>
